...
public class SpawnerScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Time.time > nouveauSpawnPiranha) {
            ...
            switch (Int)
            {
                case 0: Instantiate(PrefabPiranha, new Vector3(-1f, 0.6f, Random.Range(-0.3f, 0.3f)), Quaternion.identity); break;
                case 1: Instantiate(PrefabPiranha, new Vector3(1f, 0.6f, Random.Range(-0.3f, 0.3f)), Quaternion.identity); break;
                case 2: Instantiate(PrefabPiranha, new Vector3(Random.Range(-1f, 1f), 0.6f, -0.3f), Quaternion.identity); break;
                case 3: Instantiate(PrefabPiranha, new Vector3(Random.Range(-1f, 1f), 0.6f, 0.3f), Quaternion.identity); break;
            }
        }
